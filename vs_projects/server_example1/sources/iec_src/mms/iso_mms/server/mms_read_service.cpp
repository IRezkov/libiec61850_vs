...
static void
addComplexValueToResultList(MmsTypeSpecification* namedVariable,
...
static void
addNamedVariableToResultList(MmsTypeSpecification* namedVariable, MmsDomain* domain, char* nameIdStr,
